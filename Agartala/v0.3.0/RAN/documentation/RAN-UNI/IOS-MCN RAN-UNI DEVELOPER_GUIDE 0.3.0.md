...
```
wget https://github.com/ios-mcn/ios-mcn-releases/tree/main/Agartala/v0.3.0/RAN/source-code/iosmcn.agartala.v0.3.0.RAN.source.tar
```

Step 3: Untar the iosmcn.agartala.v0.3.0.ran.source.tar

```
tar -xvf iosmcn.agartala.v0.3.0.ran.source.tar
cd iosmcn.agartala.v0.3.0.RAN.source.tar

tar -xvzf openairinterface5g-0.3.0.openairinterface5g.tar.gz
cd openairinterface5g-0.3.0.openairinterface5g
```
...
```
**Apply patches  (available in openairinterface5g-0.3.0.openairinterface5g/cmake_targets/tools/oran_fhi_integration_patches/E)**

```
git apply openairinterface5g-0.3.0.openairinterface5g/cmake_targets/tools/oran_fhi_integration_patches/E/oaioran_E.patch
```
```
cd ~/phy/fhi_lib/lib
```
...
```
cd ~/IOSMCN-RAN-Source/iosmcn.agartala.v0.3.0.RAN.source.tar/openairinterface5g-0.3.0.openairinterface5g/cmake_targets
```
...
```
cd ~/IOSMCN-RAN-Source/iosmcn.agartala.v0.3.0.RAN.source.tar/openairinterface5g-0.3.0.openairinterface5g/common/utils/T/tracer
```
```
make all
```
This utility also needs a database file (T_messages.txt) which is also the part of tar package. You can get that file from(~/IOSMCN-RAN-Source/iosmcn.agartala.v0.3.0.RAN.source.tar/openairinterface5g-0.3.0.openairinterface5g/common/utils/T).


# V. DOCKERIZED RAN BUILD GUIDE

This Guide is intended to use to build the docker images for the ran source package
**iosmcn.agartala.v0.3.0.ran.source.tar**

```
cd ~/IOSMCN-RAN-source/iosmcn.agartala.v0.3.0.RAN.source.tar/openairinterface5g-0.3.0.openairinterface5g/docker/
```

**Follow the instructions in the README.md file present at this path [~/IOSMCN-RAN-source/iosmcn.agartala.v0.3.0.RAN.source.tar/openairinterface5g-0.3.0.openairinterface5g/docker/README.md]**
...
|---------------------|---------|-------|
| Integration Guide   |  To integrate the gNB with Radio unit and Core|https://github.com/ios-mcn/ios-mcn-releases/tree/main/Agartala/v0.3.0/RAN/documentation/RAN-UNI/IOS-MCN%20RAN-UNI%20Integration%20Guide.md |
|User Guide    | To use RAN-UNI with test environment       | https://github.com/ios-mcn/ios-mcn-releases/tree/main/Agartala/v0.3.0/RAN/documentation/RAN-UNI/IOS-MCN%20RAN-UNI%20USER_GUIDE.md       |
|Installation Guide  |  To install the UNI RAN environment    |https://github.com/ios-mcn/ios-mcn-releases/tree/main/Agartala/v0.3.0/RAN/documentation/RAN-UNI/IOS-MCN%20RAN-UNI%20INSTALLATION_GUIDE.md    |
|Troubleshooting Guide|To help the user troubleshoot issues         | https://github.com/ios-mcn/ios-mcn-releases/tree/main/Agartala/v0.3.0/RAN/documentation/RAN-UNI/IOS-MCN%20RAN-UNI%20TROUBLESHOOTING_GUIDE.md   |
