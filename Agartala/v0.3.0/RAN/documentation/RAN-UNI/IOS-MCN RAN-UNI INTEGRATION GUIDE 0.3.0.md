# **IOS MCN v0.3.0 Agartala Release  -  Integration Guide** 

##INTRODUCTION
---

This document provides a comprehensive guide for integrating both the hardware and software components required to deploy and operate the IOS MCN v0.3.0 Agartala Release. It outlines the step-by-step process to set up and bring up a functional 5G private network.

##PURPOSE AND AUDIENCE
---


The purpose of this document is to provide a clear, structured, and step-by-step approach to integrate the IOS MCN v0.3.0 Agartala Release for a 5G private network setup. It aims to ensure that all configurations, connections, and dependencies are handled correctly for a successful deployment. This document may serve as a reference during testing, troubleshooting, and validation phases of the network rollout.

This document is intended for technical professionals involved in the deployment of 5G private networks using IOS MCN v0.3.0, including system integrators, field engineers, network engineers, validation teams, R&D, and support staff. It assumes a working knowledge of 5G architecture, Linux systems, networking, and the IOS MCN platform, and serves as a practical guide for seamless integration, setup, and troubleshooting.
...
```
 cd ios-mcn-ran-uni-baremetal-v0.3.0.tar.gz
```
```
...
> *https://github.com/ios-mcn/ios-mcn-releases/tree/main/Agartala/v0.3.0/RAN/source-code/iosmcn.agartala.v0.3.0.ran.source.tar.gz*

 Copy the tar file to the target gNB machine (/home/user/) . Untar the
file using cmd.
```
 tar -xvzf ios-mcn-ran-uni-baremetal-v0.3.0.tar.gz
 cd ios-mcn-ran-uni-baremetal-v0.3.0
```
