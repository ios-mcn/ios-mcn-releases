# IOS MCN v0.3.0 Agartala Release - User Guide 
-----
...
>- Support UNIFIED RAN
>- Deployment Mode : Bare metal and Docker version
>- Band N78
...
>- VoNR and ViNR
>- Peak Throughput  Downlink >= 650 Mbps (TDD Config - DDDSU)
>- End-2-End Data Latency (Ping)  < 12 ms
>- Functional Split - Split 8 and Split 7.2
>- Connected UE capacity - 4 COTS UEs up to 12 Hours Stability (Ping and Youtube streaming)
>- Connected UE capacity - 16 Simulated UEs (RF Simulator) up to 12 Hours Stability (Ping)
>- Radio - USRP B210, VVDN RU, Lekha Marut RU
>- N2 Handover
>- RRC IDLE state
>- Paging
>- RF Simulator
...
- In this section, the test environment uses IOSMCN-Core-server i.e., a part of the *Agartala v0.3.0 IOS-MCN CORE Sub-Project Release*. The relevant guides can be referred in the same repository.
...
|---------------------|---------|-------|
| Integration Guide   |  To integration with Radio unit and Core|https://github.com/ios-mcn/ios-mcn-releases/tree/main/Agartala/v0.3.0/RAN/documentation/RAN-UNI/IOS-MCN%20RAN-UNI%20Integration%20Guide.md   |
| Developers Guide    | To build UNI RAN in Different environment       | https://github.com/ios-mcn/ios-mcn-releases/tree/main/Agartala/v0.3.0/RAN/documentation/RAN-UNI/IOS-MCN%20RAN-UNI%20DEVELOPER_GUIDE.md      |
