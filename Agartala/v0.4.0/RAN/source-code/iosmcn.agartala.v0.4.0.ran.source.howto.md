...
Follow the [RAN UNI Developer Guide](https://github.com/ios-mcn/ios-mcn-releases-pt/blob/main/Agartala/v0.4.0/RAN/documentation/RAN-UNI/IOS-MCN%20RAN-UNI%20DEVELOPER_GUIDE_0.4.0.md) document to to use the pre-built images for deployment.
