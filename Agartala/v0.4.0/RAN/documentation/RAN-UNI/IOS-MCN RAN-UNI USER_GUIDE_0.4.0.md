...
|---------------------|---------|-------|
| Integration Guide   |  To integration with Radio unit and Core|https://github.com/ios-mcn/ios-mcn-releases/blob/main/Agartala/v0.4.0/RAN/documentation/RAN-UNI/IOS-MCN%20RAN-UNI%20INTEGRATION%20GUIDE_0.4.0.md   |
