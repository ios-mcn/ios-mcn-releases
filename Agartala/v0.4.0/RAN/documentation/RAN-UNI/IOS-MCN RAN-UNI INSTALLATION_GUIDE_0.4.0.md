...
----
 ...
 Download the tar file from the Official channel IOSMCN-RAN/RELEASE-IMAGES (https://github.com/ios-mcn/ios-mcn-releases/blob/main/Agartala/v0.4.0/RAN/release-images/RAN-UNI/ios-mcn-ran-uni-baremetal-v0.4.0.tar.gz)
...
(wget https://github.com/ios-mcn/ios-mcn-releases/blob/main/Agartala/v0.4.0/RAN/release-images/RAN-UNI/ios-mcn-ran-uni-baremetal-v0.4.0.tar.gz)
...
```
cd final_artifact
sudo taskset -c 10 ./nr-softmodem -O ./<configuration file> --sa -E --usrp-tx-thread-config 1 --thread-pool 3,4,5   #conf file cand be found in the Ran.source package under the openairinterfacev0.4.0/ci-scripts 
```
