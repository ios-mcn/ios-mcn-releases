# **IOS MCN v0.4.0 Agartala Release  -  Integration Guide** 
...
> *https://github.com/ios-mcn/ios-mcn-releases/blob/main/Agartala/v0.4.0/RAN/source-code/iosmcn.agartala.v0.4.0.ran.source.tar.gz*

 Copy the tar file to the target gNB machine (/home/user/) . Untar the
file using cmd.
```
 tar -xvzf ios-mcn-ran-uni-baremetal-v0.4.0.tar.gz
