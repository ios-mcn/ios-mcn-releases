# Installation Guide – IOS-MCN-IMS v0.3.2

This guide explains how to install and run the IOS-MCN-IMS module either via Docker or on a bare metal Linux system.
...
[Refer](https://github.com/ios-mcn/ios-mcn-releases-pt/blob/main/Agartala/v0.4.0/IMS/documentation/IOS-MCN%20IMS-developer-guide.md)
...
```bash
sudo docker exec -it iosmcn-ims-container /bin/bash
```
...
```bash
sudo docker logs -f iosmcn-ims-container
```
...
```bash
sudo mv cscf/pcscf/target/pcscf-0.3.2.jar /etc/ios-mcn/pcscf.jar
```
