...
Refer this for [deployment and configuration](https://github.com/ios-mcn/ios-mcn-releases/blob/main/Agartala/v0.4.0/IMS/documentation/IOS-MCN%20IMS-developer-guide.md)

Refer this for [installation](https://github.com/ios-mcn/ios-mcn-releases/blob/main/Agartala/v0.4.0/IMS/documentation/IOS-MCN%20IMS-installation-guide.md)
...
The API guide, along with API responses can be found [here](https://github.com/ios-mcn/ios-mcn-releases/blob/main/Agartala/v0.4.0/IMS/documentation/IOS-MCN%20IMS-api-guide.md)