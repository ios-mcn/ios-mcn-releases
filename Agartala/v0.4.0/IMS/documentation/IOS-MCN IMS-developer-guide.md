# Developer Guide – IOS-MCN-IMS v0.3.2

This guide explains how to configure, build, and run the IOS-MCN-IMS project, which includes the N5 and P-CSCF modules. It supports both **Dockerized** and **Bare Metal** deployments.
...
- Default runtime parameters: `n5/defaults/iosmcn-ims-n5` and `pcscf/defaults/pcscf`
...
- `PLMN-ID=00101`
- `IOSMCNCORE=TRUE`
- IP Address of SCP HTTP2 SBI Interface in 5G Core: `SCP-IP=127.0.0.200`                    
- Port of SCP HTTP2 SBI Interface in 5G Core: `SCP-PORT=7777`                           
- IP Address of PCF HTTP2 SBI Interface in 5G Core: `PCF-IP=127.0.0.13`                    
- Port of PCF HTTP2 SBI Interface in 5G Core: `PCF-PORT=7777`                           
- IP Address of N5-Interface HTTP2 SBI Interface: `AF-BIND-IP=127.0.0.201`                
- Port of N5-Interface HTTP2 SBI Interface in 5G Core: `AF-BIND-PORT=7777`                       
- IP Address of N5-Interface SBI HTTP Interface where IMS will Request For QoS: `AF-BIND-SBI-IP=127.0.0.201`            
- Port of N5-Interface SBI HTTP Interface where IMS will Request For QoS: `AF-BIND-SBI-PORT=7782`                   
...
```bash
sudo docker build -t iosmcn-ims .
```


## Bare Metal Build [CSCF ONLY]
...
```
cscf/pcscf/target/pcscf-0.3.2.jar
```
...
### Refer the README.md file present at the source code.