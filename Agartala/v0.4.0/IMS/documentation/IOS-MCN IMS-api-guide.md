# IOS-MCN-IMS – API Guide

This document describes the REST APIs supported by the **IOS-MCN-IMS** module.
All APIs adhere to 3GPP standards and enable smooth interoperability within 5G Core IMS deployments such as **VoNR** and **ViNR**.

---

## 1. N5 Interface – API Guide

This section provides detailed information about the two primary interfaces used in the **N5 Interface – Agartala v0.4.0**:
...
### 1.2 PCF API – App Session Management
...
#### Description
Requests policy control for establishing an application session via the **Policy Control Function (PCF)**.  
Used to initiate **Audio** and **Video** PDU sessions with appropriate QoS parameters.
...
### 1.4 3GPP Technical Specifications Referred
...
## 2. Prometheus Metrics (from P-CSCF Module)
...
### URL Example
```
http://192.168.8.141:8080/actuator/prometheus
```

### Example Output
```
# HELP uptime IOS-MCN-IMS PCSCF uptime in seconds
# TYPE uptime gauge
uptime 387.576
```
